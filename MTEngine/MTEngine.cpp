// MTEngine.cpp : Defines the entry point for the application.
//
                     ...
                     int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_MTENGINE, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MTENGINE));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_MTENGINE));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_MTENGINE);
...
/* objects are read only - no object can change its public state */
void PreUpdate()
{
